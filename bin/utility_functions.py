...
def parse_arguments():
	...
	parser.add_argument('-s0',type = float, action = 'store', dest = 's0',default = 0.01, help = "the standard deviation of the spike distribution (default 0.01)")
	parser.add_argument('-n',type = int, action = 'store', default = 5, dest = "num",help = "the number of threads for the MCMC chains. Recommend at least 5")
