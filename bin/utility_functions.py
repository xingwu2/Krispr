...
def parse_arguments():
	...
	parser.add_argument('-n',type = int, action = 'store', default = 5, dest = "num",help = "the number of threads for the MCMC chains. The more threads, the more MCMC chains will run. Recommend at least 5")
